...
public class TestDal extends TestCase {
    ...
    public void testBaseDalInsert() {
        ...
        int result = dalClient.update("insert into student(name,age) values ('gpp','18')");
    ...
    public void testBatchInvoice() {
        ...
        int  lsh1=10001;
        String before="KKKAG10401";
        int  lsh2=10001;
        String kprq="2016-04-20 15:53:24";
        
        int xunhuan1=101;
        int xunhuan2=1053;
        String saleorg="2200";
        
        for(int i=0;i<xunhuan1;i++){
            long startTime=System.currentTimeMillis();
            List<Map<String,Object>> paramMap=new ArrayList<Map<String,Object>>();
            for(int j=0;j<xunhuan2;j++){
                Map<String,Object> map=JsonUtil.jsonToMap("{\"id\":2759,\"fpqqlsh\":\""+before+(lsh1+j )+"01001\",\"orderitemid\":\"00014026192901\",\"posorderid\":\""+before+"01001\",\"b2corderid\":\"2002341018\",\"sap_order_id\":\"5000004831\",\"sale_org\":\""+saleorg+"\",\"sale_org_name\":\"南京苏宁易购电子商务有限公司\",\"store_code\":\"7010\",\"old_orderitemid\":\"\",\"old_pos_order_id\":\"\",\"old_sale_org\":\"\",\"old_store_code\":\"\",\"ordertime\":\""+kprq+"\",\"znxbj\":\"1\",\"bfthbs\":\"\",\"thpcs\":\"\",\"invoices_printlog\":\"N\",\"tschbz\":\"0\",\"czdm\":\"10\",\"order_type\":\"ZOR\",\"dist_channel\":\"50\",\"verify_code\":\"4405\",\"sf_bk\":\"N\",\"fpdm\":\"151011420001\",\"fphm\":\"05029786\",\"invoice_type\":\"04\",\"invoicetitle\":\"孙磊\",\"kpjehj\":0.01,\"zkjehj\":-112.99,\"member_id\":\"6002035267\",\"member_name\":\"孙磊\",\"accepter_invoice_name\":\"孙磊\",\"mobphonenum\":\"18551603400\",\"emailinvoice\":\"\",\"common_industry_code\":\"\",\"common_industry_name\":\"\",\"maker_taxpayerno\":\"220104756197253\",\"tax_org_code\":\"\",\"busines_platform_code\":\"P0000001\",\"ballot_code\":\"\",\"status\":\"2\",\"twodimensional_code_info\":\"103E597610FAR1Q0eEO06Gg2Q000000109213XyWvx1Z19rsF23CL8993h4qW~10910421\",\"inv_status\":\"01\",\"inv_desc\":\"H00013472701001\",\"kprq\":\""+kprq+"\",\"hx_return_kplsh\":\"15101142000105029786\",\"kplx\":1,\"security_code\":\"0921E1F20E7B63049D76\",\"invoice_ticket_code\":\"21099\",\"last_accept_date\":\"2015-10-27 15:56:08\",\"accept_time\":1,\"pdf_url\":\"http://124.127.114.89:7009/51CLPro/eInvoiceDownload?fiscalCode=0921E1F20E7B63049D76\",\"pdf_file\":\"/notice/144593409385127924.pdf\",\"backup_field_fir\":\"\",\"backup_field_sec\":\"\",\"ctime\":\"2015-10-27 15:56:08\"}");
                paramMap.add(map);
            }
            lsh1=lsh1+(i+1)*xunhuan2;
        ...
        for(int i=0;i<xunhuan1;i++){
            ...
            for(int j=0;j<xunhuan2;j++){
                mapitem=JsonUtil.jsonToMap("{\"id\":2732,\"fpqqlsh\":\""+before+(lsh2+j )+"01001\",\"sale_org\":\""+saleorg+"\",\"store_code\":\"7281\",\"ordertime\":\""+kprq+"\",\"fpdm\":\"114011015609\",\"fphm\":\"12600001\",\"seqno\":\"\",\"cmmdtycode\":\"120877118\",\"cmmdtyname\":\"电子发票项目太原数据1\",\"sl\":1.000,\"dj\":56.00,\"je\":56.00,\"ysfy\":5.00,\"yhdzje\":0.00,\"ckjg\":56.00,\"tax_rate\":0.17,\"sap_product_code\":\"R0103002\",\"cmmdty_band\":\"000010254\",\"order_item_type\":\"10\",\"is_extend_flag\":\"\",\"extend_type\":\"\"}");
             paramEntityMap.add(mapitem);
            } 
            lsh2=lsh2+(i+1)*xunhuan2;
